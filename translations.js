const translations = {
    'zh-Hant': {
        ...
        inst_1: "1. 在游戏中，前往 <b>设定 > 帐号 > 帐号资讯 > 造型 QR code</b>。",
        inst_2: "2. 将该 QR Code 画面<b>截图</b>。（注意：这不是加好友的 QR Code！）",
        ...
        text_white: "浅色",
        text_black: "深色",
        confirm_clear_history: "您确定要清空所有历史纪录吗？",
        confirm_delete_item: "您确定要删除这条纪录吗？",
        item_deleted: "纪录已删除。",
        github_link: "GitHub",
        ...
        disclaimer_privacy: "所有计算均在您的浏览器中完成，QR Code 资讯不会被上传或储存至任何服务器。",
        sim_title: "重塑药水模拟器",
