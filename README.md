...
1. 在游戏中，前往 设定 > 帐号 > 帐号资讯 > 造型 QR code。
2. 将该 QR Code 画面截图。
3. 接下来，你有两种方式可以使用本工具：方法一：直接上传截图
   * 回到本工具网页，点击「选择图片」按钮，或直接将截图档案拖曳至上传区域。
方法二：贴上网址
   * 使用另一部手机或网页扫码工具读取你的截图。
   * 扫描后会得到一串以 
"https://sky.thatg.co/o=" 开头的网址。
   * 复制整个网址并贴到本工具的输入框。
...
3. You now have two ways to use this tool:Method 1: Upload the Screenshot
...
Method 2: Paste the URL
   ...
   * This will give you a URL that starts with 
"https://sky.thatg.co/o=".
